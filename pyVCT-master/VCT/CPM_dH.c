...
////////////////////////////////////////////////////////////////////////////////
inline double calcdH_CH(VOX* pv, CM* CMs, int xt, int xs, int NVX)
{
...
////////////////////////////////////////////////////////////////////////////////
inline double calcdHborder(VOX* pv, int xt, int ttag, int NVX)
{
	double dHcontact = JB;
	int nbs[8],n,nbtag;
...
////////////////////////////////////////////////////////////////////////////////
inline double calcdHdist(VOX* pv, CM* CMs, int xt, int xs, int ttag, int NVX)
{
	double dH = 0;
...
////////////////////////////////////////////////////////////////////////////////
inline double calcdHsyncytium(VOX* pv, CM* CMs, int xt, int xs, int ttag, int stag, int NVX)
{
	double dH = 0;
	double bondS, bondT;
...
////////////////////////////////////////////////////////////////////////////////
inline double calcdHcontact(VOX* pv, int xt, int xs, int ttag, int stag, int NVX, double JCMCM, double JCMMD, double JFBFB, double JFBMD,  double JFBCM)
{
...
////////////////////////////////////////////////////////////////////////////////
inline double contactenergy(int tag1, int tag2, int type1, int type2, double JCMCM, double JCMMD, double JFBFB, double JFBMD,  double JFBCM)
{
	double J;
	int type;
...
////////////////////////////////////////////////////////////////////////////////
inline double calcdHvol(int* csize, int ttag, int stag, int ttype, int stype, double TARGETVOLUME_CM, double TARGETVOLUME_FB, double INELASTICITY_CM, double INELASTICITY_FB )
{
...
////////////////////////////////////////////////////////////////////////////////
inline double calcdHprotrude(VOX* pv, CM* CMs, int xt, int xs, int ttag, int stag, int Qt, int Qs, double LMAX_CM, double LMAX_FB, double GN_CM, double GN_FB, double UNLEASH_CM, double UNLEASH_FB, double DETACH_CM, double DETACH_FB, int NVX)
{
	double dH = 0;
...
////////////////////////////////////////////////////////////////////////////////
inline double calcdHnuclei(VOX* pv, CM* CMs, int xt, int ttag, int stag, double DETACH_CM, double DETACH_FB, double VOXSIZE, int NVX)
{
	double dH = 0;
...
inline double dist(CM* CMs, int xt, int tag, int NVX)
{
	int xtx, xty;
	xty = xt/NVX; xtx = xt%NVX;
